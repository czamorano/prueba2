package es.imserso.prueba2.repository;

import es.imserso.prueba2.Prueba2App;
import es.imserso.prueba2.config.Constants;
import es.imserso.prueba2.config.audit.AuditEventConverter;
import es.imserso.prueba2.domain.PersistentAuditEvent;
...
import static es.imserso.prueba2.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
