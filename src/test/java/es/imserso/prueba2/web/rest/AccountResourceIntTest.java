package es.imserso.prueba2.web.rest;

import es.imserso.prueba2.config.Constants;
import es.imserso.prueba2.Prueba2App;
import es.imserso.prueba2.domain.Authority;
import es.imserso.prueba2.domain.User;
import es.imserso.prueba2.repository.AuthorityRepository;
import es.imserso.prueba2.repository.UserRepository;
import es.imserso.prueba2.security.AuthoritiesConstants;
import es.imserso.prueba2.service.MailService;
import es.imserso.prueba2.service.dto.UserDTO;
import es.imserso.prueba2.service.dto.PasswordChangeDTO;
import es.imserso.prueba2.web.rest.errors.ExceptionTranslator;
import es.imserso.prueba2.web.rest.vm.KeyAndPasswordVM;
import es.imserso.prueba2.web.rest.vm.ManagedUserVM;
import es.imserso.prueba2.service.UserService;
...
@SpringBootTest(classes = Prueba2App.class)
